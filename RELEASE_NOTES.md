...
- Adds LTSC/Store/MSIX/hosts, Store checking update + sandbox path, slim Windows dependency, and WinGet recognition troubleshooting cases.
- Adds a dogfood matrix covering C001-C020.
